...
/******************************************************************************
 * The abstract parent class of all game creatures, players, and npc's. 
 * You must EXTEND this class and implement the damage() method.
 * All creatures have HP, max HP, block value.
 *
 ******************************************************************************/
